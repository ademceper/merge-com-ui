...
export function UsecaseSelectPage() {
	...
	const [hoveredUseCase, setHoveredUseCase] = useState<ChannelTypeEnum | null>(
		null,
	);
	...
	const displayedUseCase =
		...
		(selectedUseCases.length > 0
			? selectedUseCases[selectedUseCases.length - 1]
			: null);
			...
			>
				<AnimatedPage className="flex w-full justify-center">
					<AuthCard className="flex h-full min-h-[600px]">
						<motion.div
							className="flex w-[480px] justify-center px-0"
...
function EmptyStateView() {
	return (
		...
		>
			...
			>
				This helps us understand your use-case better with the channels you'd
				use in your product to communicate with your users.
				<br />
				<br />
