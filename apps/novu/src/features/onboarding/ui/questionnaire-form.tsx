...
export function QuestionnaireForm() {
	...
	const shouldShowCompanySize =
		(selectedOrgType === OrganizationTypeEnum.COMPANY ||
			selectedOrgType === OrganizationTypeEnum.AGENCY) &&
		!!selectedJobTitle;
				...
				<div className="flex flex-col items-center gap-8">
					<div className="flex w-[350px] flex-col gap-1">
						...
						<CardDescription className="text-foreground-400 text-xs">
							This helps us set up Novu to match your goals and plan features
							and improvements.
						</CardDescription>
					</div>
					...
					<Form {...form}>
						<FormRoot
							...
							className="flex w-[350px] flex-col gap-8"
						>
							<div className="flex flex-col gap-7">
								<div className="flex flex-col gap-[4px]">
									<label className="text-foreground-600 text-xs font-medium">
										Job title
									</label>
									<Controller
										name="jobTitle"
										...
										render={({ field }) => (
											...
											>
												...
												<SelectContent>
													{Object.entries(jobTitleToLabelMapper).map(
														([value, label], index) => (
										...
										>
											...
											<div className="flex flex-wrap gap-[8px]">
												<Controller
													...
													render={({ field }) => (
														<>
															{Object.values(CompanySizeEnum).map(
																(size, index) => (
																	<Button
																		variant="secondary"
																		key={index}
