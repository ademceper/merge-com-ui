...
export function ActiveSubscribersTrendChart({
	data,
	isLoading,
	error,
}: ActiveSubscribersTrendChartProps) {
	...
	const hasDataChecker = useCallback(
		createDateBasedHasDataChecker<ActiveSubscribersChartData>(
			(dataPoint: ActiveSubscribersChartData) => {
