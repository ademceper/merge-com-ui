...
export const SubscriptionPreferenceRule = ({
	preference,
}: {
	preference: TopicSubscriptionPreference;
}) => {
	...
	if (preference.condition) {
		return (
			<Card className="border rounded-lg border-neutral-100 bg-neutral-50 p-1 shadow-none">
				<CardHeader
					className={cn(
						"flex w-full flex-row items-center justify-between gap-2 p-1 hover:cursor-pointer",
						{
							"pb-2": isExpanded,
						},
					)}
