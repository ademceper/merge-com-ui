					...
					<Tooltip>
						...
						>
							<Avatar className="size-15 cursor-default">
								<AvatarImage
									src={
										firstNameChar || lastNameChar ? "" : "/images/avatar.svg"
									}
								/>
								<AvatarFallback>
					...
					<FormField
						...
						render={({ field, fieldState }) => (
							<FormItem className="w-full">
								...
								<FormMessage>
									Must be unique and used to identify a subscriber
								</FormMessage>
							</FormItem>
						)}
					/>
					...
					description={
						<div className="flex flex-col gap-3">
							<span className="text-xs text-neutral-600">
								<strong>Tip:</strong> You can also Add subscriber via API, or
								create them on the fly when sending notifications.
							</span>
							<Link
