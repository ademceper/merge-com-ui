...
export const workflowSchema = z.object({
	...
	workflowId: z.string().regex(/^[a-zA-Z0-9]+(?:[-_.][a-zA-Z0-9]+)*$/, {
		message:
			"workflowId must be a valid slug format (letters, numbers, hyphens, dot and underscores only)",
	}),
	tags: z
...
export type TestWorkflowFormType = z.infer<
	ReturnType<typeof buildDynamicFormSchema>
>;
...
export const UserPreferencesFormSchema = z.object({
	...
	severity: z
		.enum(Object.values(SeverityLevelEnum) as [string, ...string[]])
