...
export const AddStepMenu = ({
	...
	const isThrottleStepEnabled = useFeatureFlag(
		FeatureFlagsKeysEnum.IS_THROTTLE_STEP_ENABLED,
	);
	...
	return (
		...
		>
			...
			<PopoverPortal>
				<PopoverContent
					side="right"
					className="flex w-[200px] flex-col rounded-lg p-0"
				>
					<div>
						<MenuGroup>
							...
							<MenuItemsGroup>
								...
								{isThrottleStepEnabled && (
									<MenuItem
										...
										onClick={() => handleMenuItemClick(StepTypeEnum.THROTTLE)}
									>
										Throttle
									</MenuItem>
								)}
