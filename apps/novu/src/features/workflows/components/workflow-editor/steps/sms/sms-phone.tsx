...
const SmsChatBubble = ({ children }: { children: React.ReactNode }) => (
	...
	>
		<div className="line-clamp-4 min-h-4 overflow-hidden whitespace-pre-wrap wrap-break-word text-xs">
			{children}
		</div>
	</motion.div>
);
...
const ErrorChatBubble = ({ children }: { children: React.ReactNode }) => (
	...
	>
		<div className="line-clamp-4 overflow-hidden whitespace-pre-wrap wrap-break-word text-xs">
			{children}
		</div>
	</motion.div>
);
