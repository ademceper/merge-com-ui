...
export type AccordionSectionProps = {
	...
	onUpdate: (
		...
		data: PayloadData | PreviewSubscriberData | StepsData | ContextPayload,
	) => void;
};
...
export type SubscriberSectionProps = Omit<
	AccordionSectionProps,
	"errors" | "localParsedData" | "onUpdate"
> & {
	error: string | null;
...
export type ContextSectionProps = Omit<
	AccordionSectionProps,
	"errors" | "localParsedData" | "onUpdate"
> & {
	error: string | null;
