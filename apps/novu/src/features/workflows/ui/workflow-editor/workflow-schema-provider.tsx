...
} from "./use-workflow-schema-manager";
...
const WorkflowSchemaContext = createContext<
	WorkflowSchemaContextType | undefined
>(undefined);
...
export function WorkflowSchemaProvider({
	children,
}: WorkflowSchemaProviderProps) {
...
export function useWorkflowSchema(): WorkflowSchemaContextType {
	...
	if (context === undefined) {
		throw new Error(
			"useWorkflowSchema must be used within a WorkflowSchemaProvider",
		);
	}
