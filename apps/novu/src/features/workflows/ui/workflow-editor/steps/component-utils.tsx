import { EnvironmentTypeEnum, UiComponentEnum } from "@/shared";
import { EmailEditorSelect } from "@/shared/ui/email-editor-select";
import { useEnvironment } from "@/app/context/environment/hooks";
import { DelayWindow } from "@/features/workflows/ui/workflow-editor/steps/delay/delay-window";
import { DigestDelayTabs } from "@/features/workflows/ui/workflow-editor/steps/digest-delay-tabs/digest-delay-tabs";
import { DigestKey } from "@/features/workflows/ui/workflow-editor/steps/digest-delay-tabs/digest-key";
import { EmailBody } from "@/features/workflows/ui/workflow-editor/steps/email/email-body";
import { EmailSubject } from "@/features/workflows/ui/workflow-editor/steps/email/email-subject";
import { InAppAction } from "@/features/workflows/ui/workflow-editor/steps/in-app/in-app-action";
import { InAppAvatar } from "@/features/workflows/ui/workflow-editor/steps/in-app/in-app-avatar";
import { InAppBody } from "@/features/workflows/ui/workflow-editor/steps/in-app/in-app-body";
import { InAppRedirect } from "@/features/workflows/ui/workflow-editor/steps/in-app/in-app-redirect";
import { InAppSubject } from "@/features/workflows/ui/workflow-editor/steps/in-app/in-app-subject";
import { ThrottleKey } from "@/features/workflows/ui/workflow-editor/steps/throttle/throttle-key";
import { ThrottleThreshold } from "@/features/workflows/ui/workflow-editor/steps/throttle/throttle-threshold";
import { ThrottleWindow } from "@/features/workflows/ui/workflow-editor/steps/throttle/throttle-window";
