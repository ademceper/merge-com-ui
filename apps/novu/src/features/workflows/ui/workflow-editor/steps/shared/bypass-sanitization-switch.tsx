...
export const BypassSanitizationSwitch = () => {
	...
	return (
		<div className="flex items-center gap-1">
			...
			/>
			<FormLabel className="text-foreground-600 text-xs">
			...
			<HelpTooltipIndicator
				...
				text={
					<>
						<p>
							By default, Novu sanitizes subject and body to ensure it is safe
							to render in In-app and email notifications.
						</p>
						<br />
						<p>
							The sanitization applies to suspicious HTML tags such as{" "}
							<script /> and entities such as &amp;, &lt;, &gt;.
						</p>
						<br />
						<p>
							Disabling content sanitization should be used with trusted trigger
							payload so as not to expose your app to security risks such as XSS
							attacks.
						</p>
					</>
				}
