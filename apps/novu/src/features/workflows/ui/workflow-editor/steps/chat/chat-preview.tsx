...
export const ChatPreview = ({
	...
	const isValidChatPreview =
		...
		previewData?.result.preview.body?.length > 0;
	const body = isValidChatPreview
	...
	return (
		<div className="relative w-full rounded-xl border border-dashed border-[#E1E4EA] p-3">
			<div className="flex flex-col gap-3">
				<div className="flex w-full items-start gap-2">
					...
					<div className="flex w-full flex-col gap-1">
						...
						{isPreviewPending ? (
							...
							<span
								className={cn(
									"text-foreground-950 min-h-4 whitespace-pre-wrap text-xs font-normal",
									{
				...
				<div
					className={cn(
						"relative z-10 flex items-start rounded-sm border border-neutral-100 px-2 py-1",
						{
				...
				>
					<div className="flex w-full items-center justify-between">
						...
						<PaperPlaneTilt
							weight="fill"
							className="text-foreground-300 size-3"
						/>
					</div>
				</div>
			</div>
