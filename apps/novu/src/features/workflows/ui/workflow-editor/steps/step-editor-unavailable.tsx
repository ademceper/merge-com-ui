...
export const StepEditorUnavailable = () => {
	...
	const handleSwitchToDevelopment = () => {
		const developmentEnvironment =
			oppositeEnvironment?.name === "Development" ? oppositeEnvironment : null;
			...
			<div className="max-w-md space-y-4 text-center">
				...
				<div className="space-y-2">
					<h3 className="text-base font-medium text-neutral-600">
						Step editor unavailable
					</h3>
					<p className="text-sm leading-relaxed text-neutral-500">
						Step editing is only available in development environments. Switch
						to a development environment to modify this step.
					</p>
				</div>
