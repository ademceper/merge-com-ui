...
const REACT_EMAIL_CONTROLS_DOCS_LINK =
	"https://docs.novu.co/framework/content/react-email#controlschema";
			...
			<div className="flex w-full flex-col items-center gap-4">
				...
				<div className="flex flex-col items-center justify-center gap-1">
					...
					<span className="text-neutral-alpha-600 w-3/4 text-center text-xs">
						This React Email template doesn't expose any editable fields. Define
						a <code className="font-mono">controlSchema</code> in your code to
