...
import { saveTranslation } from "@/entities/translation/api/translations";
import {
	showErrorToast,
	showSuccessToast,
...
type SaveTranslationParameters = OmitEnvironmentFromParameters<
	typeof saveTranslation
>;
...
export const useSaveTranslation = () => {
	...
	return useMutation({
		mutationFn: (args: SaveTranslationParameters) =>
			saveTranslation({ environment: currentEnvironment!, ...args }),
