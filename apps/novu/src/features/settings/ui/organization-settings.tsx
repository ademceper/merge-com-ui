	...
	return (
		<div className="space-y-8">
			<Protect permission={PermissionsEnum.ORG_SETTINGS_READ}>
				<div>
					<h1 className="text-label-sm text-text-strong mb-2">
										...
										<TooltipPortal>
											...
											>
												...
												<p className="mt-2 px-0.5 text-xs text-gray-500">
													Novu branding appears at the bottom of your emails and
													in your inbox.
												</p>
											</TooltipContent>
										</TooltipPortal>
			...
			<div>
				<h1 className="text-label-sm text-text-strong mb-3">
