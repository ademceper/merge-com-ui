...
const createFooterPlainText: (props: {
...
const createFooterLogoWithTextStacked: (props: {
	track: ReturnType<typeof useTelemetry>;
}) => BlockItem = (props) => {
	const { track } = props;
...
const createFooterLogoTextAndSocials: (props: {
	track: ReturnType<typeof useTelemetry>;
}) => BlockItem = (props) => {
	const { track } = props;
...
const createFooterLogoWithSimpleText: (props: {
	track: ReturnType<typeof useTelemetry>;
}) => BlockItem = (props) => {
	const { track } = props;
