...
const createHeaderCenteredLogoWithBorder: (props: {
	...
	return {
		...
		preview:
			"/images/email-editor/header-centered-logo-with-border-preview.png",
...
const createHeaderLogoWithText: (props: {
	track: ReturnType<typeof useTelemetry>;
}) => BlockItem = (props) => {
	const { track } = props;
...
const createHeaderLogoWithCoverImage: (props: {
	track: ReturnType<typeof useTelemetry>;
}) => BlockItem = (props) => {
	const { track } = props;
