...
const FILTERS: Filters[] = [
	...
	},
	{
		...
		example:
			'"<super>mario</super>" | escape → &lt;super&gt;mario&lt;/super&gt;',
	...
	},
	{
		...
		example:
			'"supercalifragilisticexpialidocious" | truncate: 10 → supercali...',
		params: [
			{ label: "Length", placeholder: "Length (e.g. 20)", type: "number" },
		],
	...
	},
	{
		...
		params: [
			{ label: "Subtract", placeholder: "Number to subtract", type: "number" },
		],
		sampleValue: "42",
	},
	{
		...
		params: [
			{
				label: "Multiply by",
				placeholder: "Number to multiply by",
				type: "number",
			},
		],
		sampleValue: "7",
	},
	{
		...
		params: [
			{
				label: "Divide by",
				placeholder: "Number to divide by",
				type: "number",
			},
		],
		sampleValue: "42",
	...
	},
	{
		...
		example:
			'"space & special chars!" | url_encode → space%20%26%20special%20chars%21',
