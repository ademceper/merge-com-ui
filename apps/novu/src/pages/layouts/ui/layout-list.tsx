...
import {
	...
	useLayoutsUrlState,
} from "@/pages/layouts/model/use-layouts-url-state";
...
import { LayoutListBlank } from "@/pages/layouts/ui/layout-list-blank";
import {
	LayoutRow,
	LayoutRowSkeleton,
} from "@/pages/layouts/ui/layout-row";
import { LayoutsFilters } from "@/pages/layouts/ui/layouts-filters";
...
export const LayoutList = (props: LayoutListProps) => {
	const { filterValues, handleFiltersChange, toggleSort, resetFilters } =
		useLayoutsUrlState();
	...
	const areFiltersApplied = (
		Object.keys(filterValues) as (keyof LayoutsFilter)[]
	).some((key) => ["query"].includes(key) && filterValues[key] !== "");
