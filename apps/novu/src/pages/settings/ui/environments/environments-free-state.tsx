...
import { BookBookmark, BookmarkIcon, Sparkle } from "@phosphor-icons/react";
    ...
    <div className="flex h-full w-full flex-col items-center justify-center gap-6 px-4">
      <div className="flex w-full max-w-120 flex-col items-center gap-6 text-center">
        ...
        <div className="flex flex-col items-center gap-1">
          ...
          <Link
            href="https://docs.merge.com/platform/developer/environments"
            target="_blank"
          >
            How does this help?
          </Link>
