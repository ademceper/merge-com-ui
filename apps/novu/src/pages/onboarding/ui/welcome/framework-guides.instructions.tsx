		...
		installSteps: stepsByMethod(
			...
			[
				commonInstallStep("@novu/nextjs"),
				{
					...
					description:
						"Inbox utilizes the Next.js router to enable navigation within your notifications.",
		...
		installSteps: stepsByMethod(
			...
			[
				commonInstallStep("@novu/react"),
				{
					...
					description:
						"Inbox utilizes the routerPush prop to enable navigation within your notifications.",
					code: `import { Inbox } from '@novu/react';
		...
		installSteps: stepsByMethod(
			...
			[
				commonInstallStep("@novu/react-native"),
				{
					...
					description:
						"Implement the notification center in your React Native application.",
    ...
    >
      <YourCustomInbox />
				...
				},
				{
					...
					description:
						"Build your custom inbox component to use within your app.",
					code: `import {
  FlatList,
  View,
  Text,
		...
		installSteps: stepsByMethod(
			...
			[
				commonInstallStep("@novu/js"),
				{
					...
					description:
						"Currently, angular applications are supported with the Novu UI library.",
