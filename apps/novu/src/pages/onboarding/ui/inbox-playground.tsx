...
const PLAYGROUND_CONFIG = {
	...
	description:
		"See in-app notifications in action with a live preview of the inbox component",
	currentStep: 2,
	totalSteps: 4,
} as const;
...
export function InboxPlayground({
	...
	const handleNextStepClick = () => {
		...
		navigate({ to: qs ? `${ROUTES.INBOX_EMBED}?${qs}` : ROUTES.INBOX_EMBED });
	};
					...
					{!hasNotificationBeenSent ? (
						...
						<Button
							...
							style={{
								...
								boxShadow:
									"0px 1px 2px rgba(14, 18, 27, 0.24), 0px 0px 0px 1px #DD2450",
								fontFamily: "Inter",
								fontSize: "12px",
								lineHeight: "16px",
								fontWeight: 500,
