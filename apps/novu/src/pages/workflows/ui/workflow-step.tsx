...
import { Step, type StepProps } from "@/shared/ui/primitives/step";
...
const stepRenderData: Record<
	StepTypeEnum,
	{ variant: ComponentProps<typeof Step>["variant"]; icon: IconType }
> = {
	[StepTypeEnum.CHAT]: {
		variant: "feature",
	...
	[StepTypeEnum.CUSTOM]: {
		variant: "alert",
		icon: STEP_TYPE_TO_ICON[StepTypeEnum.CUSTOM],
	},
	[StepTypeEnum.DELAY]: {
		variant: "warning",
		icon: STEP_TYPE_TO_ICON[StepTypeEnum.DELAY],
	},
	[StepTypeEnum.DIGEST]: {
		variant: "highlighted",
		icon: STEP_TYPE_TO_ICON[StepTypeEnum.DIGEST],
	},
	[StepTypeEnum.EMAIL]: {
		variant: "information",
	...
	[StepTypeEnum.THROTTLE]: {
		variant: "destructive",
		icon: STEP_TYPE_TO_ICON[StepTypeEnum.THROTTLE],
	},
	[StepTypeEnum.TRIGGER]: {
		variant: "neutral",
		icon: STEP_TYPE_TO_ICON[StepTypeEnum.TRIGGER],
	},
};
