...
export function HelpIcon({
	...
	const IconComponent = hasError ? WarningCircle : Info;
	...
	return (
		<HoverCard openDelay={100}>
			<HoverCardTrigger asChild>
				<div
					className="mr-1 flex cursor-help items-center justify-center"
					role="button"
					tabIndex={-1}
				>
			...
			<HoverCardContent className={`${contentWidth} p-2`}>
				<div>
					...
					{hasError && errorMessage && (
						<>
							<div className="text-label-xs mb-1 font-medium text-red-600">
								{errorMessage}
							</div>
							{helpText && (
								<div className="mb-1.5 border-t border-neutral-200" />
							)}
						</>
					)}
						...
						<>
							<div className="flex items-start gap-2">
								<div className="flex-1">
									...
									<div className="text-label-xs mt-1 text-gray-600">
