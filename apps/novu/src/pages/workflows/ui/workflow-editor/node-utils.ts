...
import { getFirstErrorMessage } from "@/pages/workflows/ui/workflow-editor/step-utils";
...
export const NODE_TYPE_TO_STEP_TYPE: Omit<
	Record<keyof typeof nodeTypes, StepTypeEnum>,
	"add"
> = {
...
export const mapStepToNode = ({
	...
	const content = mapStepToNodeContent(
		step.type,
	...
	const error = step.issues
		? getFirstErrorMessage(step.issues, "controls") ||
...
const createNodes = (
	...
	const allNodes: Node<NodeData, keyof typeof nodeTypes>[] = [
		triggerNode,
		...createdNodes,
	];
