...
import { Maily } from "@/widgets/maily-editor/maily";
import {
	createEditorBlocks,
	DEFAULT_BLOCK_CONFIG,
} from "@/widgets/maily-editor/maily-config";
import { isMailyJson } from "@/widgets/maily-editor/maily-utils";
import type { VariableFrom } from "@/widgets/maily-editor/types";
import {
	MailyVariablesListView,
	type VariableSuggestionsPopoverRef,
} from "@/widgets/maily-editor/views/maily-variables-list-view";
import {
	BubbleMenuVariablePill,
	NodeVariablePill,
} from "@/widgets/maily-editor/views/variable-view";
...
import { useCreateTranslationKey } from "@/pages/translations/api/use-create-translation-key";
...
const BubbleMenuVariablePillForWorkflows = ({
	...
	const { isPayloadSchemaEnabled, getSchemaPropertyByKey } =
		useWorkflowSchema();
	const {
...
export const EmailBodyMaily = () => {
	...
	const renderVariable = useCallback(
		(opts: {
			...
			return (
				<BubbleMenuVariablePillForWorkflows
					opts={opts}
