...
import type { UpdateTranslationValueParams } from "@/pages/translations/api/use-update-translation-value";
...
const useAutoSave = (
	...
	updateTranslationValue: UseMutationResult<
		any,
		Error,
	...
	useEffect(() => {
		...
		const needsKeyReplace =
			hasUserEditedKey && onReplaceKey && trimmedKey !== initialKeyOnOpen;
