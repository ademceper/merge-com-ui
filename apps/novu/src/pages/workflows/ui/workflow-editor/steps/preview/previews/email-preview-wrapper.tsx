...
import { EmailTabsSection } from "@/pages/workflows/ui/workflow-editor/steps/email/email-tabs-section";
											...
											<TabsContent value="desktop" className="h-full">
												...
												>
													<EmailPreviewBody
														...
														className={
															isCustomHtmlEditor
																? "bg-background max-w-auto max-w-none rounded-lg"
																: ""
														}
													/>
												</div>
