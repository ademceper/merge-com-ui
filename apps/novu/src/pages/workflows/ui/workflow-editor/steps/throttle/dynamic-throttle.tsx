	...
	const tooltipContent = (
		<div className="space-y-2">
			...
			<div>
				...
				<p>
					<code className="text-xs">payload.releaseTime</code>,{" "}
					<code className="text-xs">payload.throttleWindow</code>
				</p>
			</div>
		</div>
	);
						...
						<VariableSelect
							...
							emptyState={
								<p className="text-foreground-600 mt-1 p-1 text-xs">
									Select a payload variable to define the dynamic throttle
									window
								</p>
							}
						/>
