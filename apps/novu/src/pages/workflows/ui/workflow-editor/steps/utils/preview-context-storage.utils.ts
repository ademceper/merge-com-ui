...
function getSubscriberStorageKey(
	workflowId: string,
	environmentId: string,
): string {
...
export function savePayloadData(
	workflowId: string,
	environmentId: string,
	payload: PayloadData,
): void {
...
export function saveSubscriberData(
	workflowId: string,
	environmentId: string,
...
export function saveContextData(
	workflowId: string,
	environmentId: string,
...
export function loadPayloadData(
	workflowId: string,
	environmentId: string,
): PayloadData | null {
	const storageKey = getPayloadStorageKey(workflowId, environmentId);
...
export function loadSubscriberData(
	workflowId: string,
	environmentId: string,
...
export function mergePreviewContextData(
	...
	return {
		...
		subscriber: mergeObjectData(
			persistedData.subscriber,
			serverDefaults.subscriber,
		),
...
function mergeObjectData<T extends Record<string, unknown>>(
	persisted: T,
	serverDefault: T,
): T {
	...
	for (const key of Object.keys(persisted)) {
		if (key in serverDefault) {
			...
			merged[key] = isNestedObject
				? mergeObjectData(
						persisted[key] as Record<string, unknown>,
						serverDefault[key] as Record<string, unknown>,
					)
				: persisted[key];
		}
	}
...
export function clearPayloadData(
	workflowId: string,
	environmentId: string,
): void {
	const storageKey = getPayloadStorageKey(workflowId, environmentId);
