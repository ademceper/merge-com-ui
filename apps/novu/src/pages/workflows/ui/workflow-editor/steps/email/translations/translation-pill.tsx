...
import { VariableIcon } from "@/widgets/variable-editor/components/variable-icon";
import { useFetchTranslationKeys } from "@/pages/translations/api/use-fetch-translation-keys";
import { useTranslationValidation } from "@/pages/translations/lib/use-translation-validation";
	...
	return (
		<>
			<TranslationTooltip hasError={hasError} errorMessage={errorMessage}>
				...
				>
					<VariableIcon
						variableName={decoratorKey}
						hasError={hasError}
						context="translations"
					/>
					<span
						className="text-text-sub max-w-[24ch] truncate leading-[1.2] antialiased"
						title={displayTranslationKey}
					>
