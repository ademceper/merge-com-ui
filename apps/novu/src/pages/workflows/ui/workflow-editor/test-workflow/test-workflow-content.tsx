...
import { PreviewPayloadSection } from "@/pages/workflows/ui/workflow-editor/steps/components/preview-payload-section";
import type {
	PayloadData,
			...
			<div className="bg-bg-weak flex-1 min-h-0 overflow-auto">
				...
				>
					<PreviewPayloadSection
						...
						schema={
							isPayloadSchemaEnabled ? workflow?.payloadSchema : undefined
						}
