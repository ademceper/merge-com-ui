...
import { TranslationSwitch } from "@/pages/translations/ui/translation-switch";
...
export function TranslationToggleSection({
	...
	const hasTargetLocales =
		(organizationSettings?.data?.targetLocales?.length ?? 0) > 0;
			...
			<div className="flex items-center justify-between border-t border-neutral-100 pt-4">
						...
						<Tooltip>
							...
							<TooltipPortal>
								<TooltipContent side="left" hideWhenDetached>
									When enabled, allows you to create and manage translations for
									your workflow content across different languages.
								</TooltipContent>
							</TooltipPortal>
						</Tooltip>
					</div>
					<p className="text-foreground-400 text-2xs mb-1">
				...
				>
					<Button
						...
						mode="ghost"
						size="xs"
						onClick={() => navigate({ to: translationsUrl })}
