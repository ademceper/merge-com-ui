...
import { useDeleteTranslationGroup } from "@/pages/translations/api/use-delete-translation-group";
...
export function useDeleteTranslationModal() {
	...
	const { mutateAsync: deleteTranslationGroup, isPending: isDeletePending } =
		useDeleteTranslationGroup();
