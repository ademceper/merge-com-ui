...
import { useExportMasterJson } from "@/pages/translations/lib/use-export-master-json";
import { defaultTranslationsFilter } from "@/pages/translations/model/use-translations-url-state";
import { useUploadMasterJson } from "@/pages/translations/lib/use-upload-master-json";
...
function ActionButtons() {
	...
	const handleConfigure = () => {
		if (environmentSlug) {
			navigate({ to: buildRoute(ROUTES.TRANSLATION_SETTINGS, { environmentSlug }) });
		}
	};
...
type TranslationsFiltersProps = HTMLAttributes<HTMLFormElement> & {
	onFiltersChange: (filter: TranslationsFilter) => void;
	filterValues: TranslationsFilter;
	onReset?: () => void;
	isFetching?: boolean;
...
export function TranslationsFilters({
	...
	const { form, handleReset, isResetButtonVisible } =
		useTranslationsFiltersLogic(filterValues, onFiltersChange, onReset);
