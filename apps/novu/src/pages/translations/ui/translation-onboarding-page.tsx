...
export const TranslationOnboardingPage = () => {
	...
	const handleViewWorkflows = () => {
		if (environmentSlug) {
			navigate({ to: buildRoute(ROUTES.WORKFLOWS, { environmentSlug }) });
		}
	};
		...
		<div className="flex h-full w-full items-center justify-center p-6">
			<div className="flex w-full max-w-4xl flex-col items-start justify-center gap-6 p-6">
				...
				<div className="flex flex-col gap-1">
					<h2 className="text-text-strong text-base font-medium">
						No translations yet — Let’s set things up
					</h2>
					<p className="text-text-soft text-xs font-medium">
						Start localizing your notifications in just a few steps.
					</p>
				</div>
							...
							<TimelineStep
								...
								leftExtraContent={
									<InlineToast
										...
										description={
											<>
												Don't worry about getting this perfect — you can add
												more languages anytime.{" "}
												<Link
