...
export function useTranslationEditor(
	selectedTranslation: TranslationResponseDto | undefined,
) {
	const [modifiedContentString, setModifiedContentString] = useState<
		string | null
	>(null);
	const [modifiedContent, setModifiedContent] = useState<Record<
		string,
		any
	> | null>(null);
	...
	const hasUnsavedChanges =
		!modifiedContentString || !selectedTranslation
			? false
			: modifiedContentString !== originalContent;
