...
import { useCreateIntegration } from "@/pages/integrations/api/use-create-integration";
import { useFetchIntegrations } from "@/pages/integrations/api/use-fetch-integrations";
import { useIntegrationList } from "@/pages/integrations/lib/use-integration-list";
...
import { useSidebarNavigationManager } from "@/pages/integrations/lib/use-sidebar-navigation-manager";
...
type CreateIntegrationSidebarProps = {
	isOpened: boolean;
};
...
export function CreateIntegrationSidebar({
	...
	const handleIntegrationSelect = (integrationId: string) => {
		navigate({
			to: buildRoute(ROUTES.INTEGRATIONS_CONNECT_PROVIDER, {
	...
	const handleBack = () => {
		navigate({ to: ROUTES.INTEGRATIONS_CONNECT, replace: true });
	};
