...
import { CreateSubscriberForm } from "@/pages/subscribers/ui/create-subscriber-form";
import { CreateSubscriberFormSchema } from "@/pages/subscribers/ui/schema";
import { useCreateSubscriber } from "@/pages/subscribers/api/use-create-subscriber";
...
export function CreateSubscriberPage() {
	...
	const { createSubscriber, isPending } = useCreateSubscriber({
		onSuccess: () => {
			showSuccessToast(
				"Created subscriber successfully",
				undefined,
				toastOptions,
			);
	...
	const onSubmit = async (
		formData: z.infer<typeof CreateSubscriberFormSchema>,
	) => {
