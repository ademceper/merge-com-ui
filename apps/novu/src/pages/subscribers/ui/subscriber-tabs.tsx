...
import { Preferences } from "@/pages/subscribers/ui/preferences/preferences";
import { PreferencesSkeleton } from "@/pages/subscribers/ui/preferences/preferences-skeleton";
import { SubscriberActivity } from "@/pages/subscribers/ui/subscriber-activity";
import { SubscriberOverviewForm } from "@/pages/subscribers/ui/subscriber-overview-form";
import { SubscriberOverviewSkeleton } from "@/pages/subscribers/ui/subscriber-overview-skeleton";
import { SubscriberSubscriptions } from "@/pages/subscribers/ui/subscriptions/subscriber-subscriptions";
import { useFetchSubscriber } from "@/pages/subscribers/api/use-fetch-subscriber";
import useFetchSubscriberPreferences from "@/pages/subscribers/api/use-fetch-subscriber-preferences";
			...
			<header className="border-bg-soft flex h-12 w-full flex-row items-center gap-3 border-b px-3 py-4">
				<div className="flex flex-1 items-center gap-1 overflow-hidden text-sm font-medium">
					...
					<TruncatedText className="flex-1">
						Subscriber Profile - {subscriberId}
					</TruncatedText>
				</div>
			</header>
...
const ActiveTabIndicator = () => {
	return (
		<motion.div
			layoutId="active-tab"
			className="bg-primary-base absolute bottom-0 left-0 right-0 z-10 h-[2px]"
		/>
	);
};
