...
const ScheduleTableHeaderColumn = (props: ScheduleTableHeaderColumnProps) => {
	return (
		<div className={cn("text-xs truncate text-start", props.className)}>
			{props.children}
		</div>
	);
};
...
export const ScheduleTable = (props: ScheduleTableProps) => {
	...
	return (
		<div className="flex flex-col gap-1">
			<ScheduleTableHeader>
				<ScheduleTableHeaderColumn className="flex-1">
					Days
				</ScheduleTableHeaderColumn>
				<ScheduleTableHeaderColumn className="min-w-[100px]">
					From
				</ScheduleTableHeaderColumn>
				<ScheduleTableHeaderColumn className="min-w-[100px]">
					To
										...
										try {
											const updatedWeeklySchedule = {
												...
												[day]: {
													...
													isEnabled: checked,
													hours: schedule?.weeklySchedule?.[day]?.hours || [
											...
											showErrorToast(
												"Failed to update day schedule. Please try again.",
											);
										}
									}}
								/>
										...
										try {
											const updatedWeeklySchedule = {
												...
												[day]: {
													...schedule?.weeklySchedule?.[day],
													isEnabled:
														schedule?.weeklySchedule?.[day]?.isEnabled ?? true,
													hours: [
														{
															start: value,
											...
											showErrorToast(
												"Failed to update start time. Please try again.",
											);
										}
									}}
								>
								...
								<Select
									...
									onValueChange={async (value) => {
										try {
											const updatedWeeklySchedule = {
												...
												[day]: {
													...
													hours: [
														{
															start:
																schedule?.weeklySchedule?.[day]?.hours?.[0]
																	?.start || "09:00 AM",
															end: value,
														},
													],
											...
											showErrorToast(
												"Failed to update end time. Please try again.",
											);
										}
									}}
								>
