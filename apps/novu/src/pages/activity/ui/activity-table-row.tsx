...
function getSubscriberDisplay(
	subscriber?: Pick<
		ISubscriber,
		"_id" | "subscriberId" | "firstName" | "lastName"
	>,
...
export function ActivityTableRow({
	...
	const subscriberDisplay = getSubscriberDisplay(
		activity.subscriber as Pick<
			ISubscriber,
			"_id" | "subscriberId" | "firstName" | "lastName"
		>,
	);
	const truncatedTransactionId = truncateText(activity.transactionId);
	const truncatedSubscriberDisplay = subscriberDisplay
		? truncateText(subscriberDisplay)
		: "";
