	...
	return (
		<AnimatePresence mode="wait">
			<motion.div
				key="empty-state"
				className={cn(
					"flex h-full w-full items-center justify-center border-t border-t-neutral-200",
					className,
				)}
				initial={{ opacity: 0 }}
				animate={{ opacity: 1 }}
	...
	return (
		...
		>
			...
			<rect
				...
				height="5"
				rx="2.5"
				fill="url(#paint0_linear_7279_27982)"
			/>
			<rect
				x="44.5"
				y="103.5"
				...
				height="5"
				rx="2.5"
				fill="url(#paint1_linear_7279_27982)"
			/>
			<path
				d="M68.5 76.625V49.375"
				stroke="#E1E4EA"
				strokeWidth="0.75"
