...
import { useRemoveTopicSubscriber } from "@/pages/topics/lib/use-topic-subscribers";
...
export function TopicSubscriberItem({
	topicKey,
	subscription,
	readOnly = false,
}: TopicSubscriberItemProps) {
					...
					<div className="grid w-full grid-cols-[150px_1fr_120px_auto] items-center px-3 py-2">
						<div className="flex max-w-[150px] items-center gap-3 overflow-hidden">
							<Avatar className="size-8">
								<AvatarImage
									src={subscription.subscriber.avatar || undefined}
								/>
							...
							<div className="flex flex-col items-start overflow-hidden">
								...
								{subscription.subscriber.email && (
									<div className="flex">
										<span className="text-label-2xs truncate text-neutral-500">
											{subscription.subscriber.email}
										</span>
									</div>
								)}
			...
			<ConfirmationModal
				...
				description={
					<>
						...
						from this topic? This action cannot be undone.
					</>
				}
