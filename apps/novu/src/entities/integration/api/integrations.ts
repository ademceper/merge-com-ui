import type { ChannelTypeEnum, IEnvironment, IIntegration } from "@/shared";
import { del, get, post, put } from "@/shared/api/api.client";
...
export async function setAsPrimaryIntegration(
