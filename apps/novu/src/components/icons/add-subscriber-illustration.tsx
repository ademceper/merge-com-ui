...
export const AddSubscriberIllustration = (
	props: AddSubscriberIllustrationProps,
) => {
	return (
		<svg
		...
		>
			...
			<path
				fill="#99A0AE"
				d="M68.125 102.125v-2.25h.75v2.25h2.25v.75h-2.25v2.25h-.75v-2.25h-2.25v-.75h2.25Z"
			/>
