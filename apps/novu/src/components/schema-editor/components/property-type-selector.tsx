...
export function PropertyTypeSelector({
	...
	const currentDefinition = useWatch({ control, name: definitionPath }) as
		| JSONSchema7
		| undefined;
	...
	const handleTypeChange = useCallback(
		(newSchemaType: JSONSchema7TypeName | "enum") => {
			...
			if (newSchemaType === "enum") {
				...
				newTransformedSchema = {
					...currentDef,
					type: newSchemaType as JSONSchema7TypeName,
				};
			...
			setValue(definitionPath, newTransformedSchema, {
				shouldValidate: true,
				shouldDirty: true,
			});
		},
