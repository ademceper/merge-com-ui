		...
		const notifyMobileSetup = async () => {
			try {
				...
				const shouldSendEmail =
					!lastSentAt || now - parseInt(lastSentAt, 10) > ONE_HOUR_MS;
				...
				showErrorToast(
					"Failed to send mobile setup email, please visit this page from Desktop.",
				);
			}
		};
		...
		<div className="flex min-h-[400px] flex-col items-center justify-center space-y-6 px-4 text-center">
			...
			<div className="space-y-3">
				...
				<div className="space-y-2">
					...
					<p className="text-sm font-medium text-gray-950">
						We see you signed up from your mobile—nice move! But to complete the
						Novu setup, you'll need to switch over to your laptop and fire up
						your favorite IDE.
					</p>
					<p className="text-sm text-gray-500">
						Integrating Novu into your stack means writing some actual code,
						setting up workflows, configuring Inbox , and composing your first
						email.
					</p>
					<p className="text-primary text-sm font-medium">
						Check your inbox! We've sent you the setup instructions to get
						started.
					</p>
				</div>
			</div>
