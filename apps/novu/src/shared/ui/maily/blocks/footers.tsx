import { EmailFooter } from "@/shared/ui/icons/email-footer";
import { EmailFooterLogoWithTextStacked } from "@/shared/ui/icons/email-footer-logo-with-text-stacked";
import { EmailFooterPlainText } from "@/shared/ui/icons/email-footer-plain-text";
...
export const createFooterPlainText: (props: {
...
export const createFooterLogoWithTextStacked: (props: {
	track: ReturnType<typeof useTelemetry>;
}) => BlockItem = (props) => {
	const { track } = props;
...
export const createFooterLogoTextAndSocials: (props: {
	track: ReturnType<typeof useTelemetry>;
}) => BlockItem = (props) => {
	const { track } = props;
	...
	return {
		...
		preview:
			"/images/email-editor/footer-logo-with-social-media-icons-preview.png",
...
export const createFooterLogoWithSimpleText: (props: {
	track: ReturnType<typeof useTelemetry>;
}) => BlockItem = (props) => {
	const { track } = props;
...
export const createFooters = (props: {
	track: ReturnType<typeof useTelemetry>;
}) => {
	const { track } = props;
