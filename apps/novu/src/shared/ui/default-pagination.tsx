	...
	return (
		<Pagination>
			<PaginationContent>
				...
				<PaginationItem>
					<PaginationPrevious
						to={hrefFromOffset(Math.max(0, offset - limit))}
				...
				{(() => {
					...
					if (endPage < totalPages) {
						...
						pageItems.push(
							<PaginationItem key={totalPages}>
								<PaginationLink to={hrefFromOffset((totalPages - 1) * limit)}>
									{totalPages}
								</PaginationLink>
							</PaginationItem>,
						);
					...
					pageItems.push(
						<PaginationItem key="end">
							<PaginationEnd
								to={hrefFromOffset((totalPages - 1) * limit)}
								isDisabled={currentPage === totalPages}
							/>
						</PaginationItem>,
					);
