		...
		<div className="flex w-full flex-col items-center justify-center gap-8">
			<div className="flex w-full flex-col items-start gap-1">
				...
				<div className="flex flex-col gap-1">
					<h2 className="text-lg font-medium text-[#232529]">
						How do you plan to use Novu?
					</h2>
					<p className="text-xs text-[#717784]">
						You can route notifications across channels intelligently with
						Novu's powerful workflows, among the channels below.
					</p>
				</div>
			</div>
							...
							>
								...
								>
									<div className="flex items-start gap-3.5 rounded-[9px] bg-[#ffffff] p-4">
										...
										>
											<option.icon
												className={`h-8 w-8 fill-${option.color} stroke-${option.color}`}
											/>
										</div>
										<div className="flex flex-col gap-1">
											<h3 className="text-sm font-medium text-[#232529]">
												{option.title}
											</h3>
											<p className="text-xs text-[#717784]">
												{option.description}
