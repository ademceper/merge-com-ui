				...
				>
					...
					<div className="flex flex-col gap-1">
						...
						<DialogDescription className="text-foreground-600 space-y-3">
							...
							<p className="text-sm">
								All applications using the current keys will need to be updated
								with the new keys immediately after regeneration.
							</p>
						</DialogDescription>
					</div>
					...
					<div className="w-full space-y-2">
						<label
							htmlFor="environment-confirmation"
							className="text-foreground-700 text-sm font-medium"
						>
							Type <span className="font-semibold">{environment.name}</span> to
							confirm
						</label>
						<Input
