...
function PaginationGroup({ children }: PaginationGroupProps) {
	return (
		<div className="flex items-center rounded-8 border border-stroke-soft bg-bg-white overflow-hidden">
			{children}
		</div>
	);
}
...
export function TablePaginationFooter({
	...
	return (
		<div
			className={cn(
				"flex w-full items-center bg-bg-white px-3 py-2",
				className,
			)}
		>
			...
			<div className="flex items-center justify-end flex-1">
				...
				>
					<SelectTrigger
						size="2xs"
						rightIcon={<CaretDown className="size-5 text-icon-sub" />}
