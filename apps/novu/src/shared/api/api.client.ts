...
import { getMockResponse, MOCK_ENABLED } from "@/shared/data/mock-api";
...
export const get = <T>(
	endpoint: string,
	{ environment, signal, headers }: RequestOptions = {},
...
export const del = <T>(
	endpoint: string,
	{ environment, signal }: RequestOptions = {},
