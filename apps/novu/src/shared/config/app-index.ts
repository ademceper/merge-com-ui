...
export const API_HOSTNAME =
	window._env_?.VITE_API_HOSTNAME || import.meta.env.VITE_API_HOSTNAME;

export const IS_EU = API_HOSTNAME === "https://eu.api.novu.co";

export const WEBSOCKET_HOSTNAME =
	window._env_?.VITE_WEBSOCKET_HOSTNAME ||
	import.meta.env.VITE_WEBSOCKET_HOSTNAME;
...
export const LEGACY_DASHBOARD_URL =
	window._env_?.VITE_LEGACY_DASHBOARD_URL ||
	import.meta.env.VITE_LEGACY_DASHBOARD_URL;

export const DASHBOARD_URL =
	window._env_?.VITE_DASHBOARD_URL || import.meta.env.VITE_DASHBOARD_URL;

export const PLAIN_SUPPORT_CHAT_APP_ID = import.meta.env
	.VITE_PLAIN_SUPPORT_CHAT_APP_ID;

export const ONBOARDING_DEMO_WORKFLOW_ID = "onboarding-demo-workflow";

export const IS_SELF_HOSTED =
	(window._env_?.VITE_SELF_HOSTED || import.meta.env.VITE_SELF_HOSTED) ===
	"true";

export const IS_ENTERPRISE =
	(window._env_?.VITE_NOVU_ENTERPRISE ||
		import.meta.env.VITE_NOVU_ENTERPRISE) === "true";

// Auth validation removed — auth is disabled

export const SELF_HOSTED_UPGRADE_REDIRECT_URL =
	"https://go.novu.co/hosted-upgrade";
