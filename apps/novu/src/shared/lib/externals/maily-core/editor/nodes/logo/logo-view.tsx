...
export function LogoView(props: NodeViewProps) {
	...
	const [_isPlaceholderImage, setIsPlaceholderImage] = useState(false);
	...
	const handleImageUpload = useCallback(
		...
		[onImageUpload, editor.chain, isDroppable],
	);
	...
	const handleDrop = useCallback(
		...
		[handleImageUpload, allowedMimeTypes.includes, isDroppable],
	);
	...
	}, [logoSrc, editor?.extensionStorage?.imageUpload?.placeholderImages?.has]);
