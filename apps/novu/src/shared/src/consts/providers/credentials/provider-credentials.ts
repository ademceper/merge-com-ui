...
export const sendgridConfig: IConfigCredential[] = [
	...
	},
	{
		...
		displayName: "Region",
		description:
			"Select EU if your SendGrid account is hosted in the EU data center",
		type: "dropdown",
		required: false,
		value: "global",
		dropdown: [
...
export const msTeamsConfig: IConfigCredential[] = [
	...
	},
	{
		...
		displayName: "Redirect URL",
		description:
			"Redirect after Teams OAuth flow finished (default behaviour will close the tab)",
		type: "string",
		required: false,
	},
];
...
export const unifonicConfig: IConfigCredential[] = [
	{
		...
		displayName: "App SID",
		description:
			"Authentication string that uniquely identifies your application.",
		type: "string",
		required: true,
	},
	{
		...
		displayName: "Sender ID",
		description:
			"The SenderID identifies who has sent the SMS message, typically a brand name",
		type: "string",
		required: true,
	},
	...smsConfigBase,
...
export const appIOConfig: IConfigCredential[] = [
	{
		...
		displayName: "Base URL",
		description:
			"Base URL of the App IO API (e.g., https://api.io.italia.it/api/v1)",
		type: "text",
		required: true,
	},
	...pushConfigBase,
