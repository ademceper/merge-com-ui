...
const novuServiceTiers: Record<
	FeatureNameEnum,
	Record<ApiServiceLevelEnum, FeatureValue>
> = {
	[FeatureNameEnum.PLATFORM_SUPPORT_SLA]: {
		...
		[ApiServiceLevelEnum.BUSINESS]: {
			label: "48 hours support SLA",
			value: 48,
			timeSuffix: "h",
		},
		[ApiServiceLevelEnum.ENTERPRISE]: {
			label: "24 hours support SLA",
			value: 24,
			timeSuffix: "h",
		},
	...
	[FeatureNameEnum.PAYMENT_METHOD]: {
		...
		[ApiServiceLevelEnum.PRO]: {
			label: "Payment via Credit card only",
			value: true,
		},
		[ApiServiceLevelEnum.BUSINESS]: {
			label: "Credit card & PO and Invoicing",
			value: true,
		},
		[ApiServiceLevelEnum.ENTERPRISE]: {
			label: "Credit card & PO and Invoicing",
	...
	[FeatureNameEnum.PLATFORM_SUPPORT_CHANNELS]: {
		...
		[ApiServiceLevelEnum.BUSINESS]: {
			label: "Slack & Email support",
			value: true,
		},
		[ApiServiceLevelEnum.ENTERPRISE]: {
			label: "Slack & Email priority support",
			value: true,
		},
		[ApiServiceLevelEnum.UNLIMITED]: {
			label: "Slack & Email support",
	...
	[FeatureNameEnum.PLATFORM_MONTHLY_EVENTS_INCLUDED]: {
		[ApiServiceLevelEnum.FREE]: {
			value: 10000,
			label: "10,000 events included",
		},
		[ApiServiceLevelEnum.PRO]: {
			value: 30000,
			label: "30,000 events included",
		},
		[ApiServiceLevelEnum.BUSINESS]: {
			value: 250000,
			label: "250,000 events included",
		},
		[ApiServiceLevelEnum.ENTERPRISE]: {
			value: 5000000,
			label: "5,000,000 events included",
		},
		[ApiServiceLevelEnum.UNLIMITED]: {
			value: 5000000,
			label: "5,000,000 events included",
	...
	[FeatureNameEnum.PLATFORM_COST_PER_ADDITIONAL_1K_EVENTS]: {
		...
		[ApiServiceLevelEnum.PRO]: {
			label: "$1.20 per 1,000 additional events",
			value: 1.2,
		},
		[ApiServiceLevelEnum.BUSINESS]: {
			label: "$1.20 per 1,000 additional events",
		...
		[ApiServiceLevelEnum.ENTERPRISE]: {
			label: "Custom pricing for additional events",
			value: 1.2,
		},
		[ApiServiceLevelEnum.UNLIMITED]: {
			label: "Custom pricing for additional events",
	...
	[FeatureNameEnum.PLATFORM_SUBSCRIBERS]: {
		[ApiServiceLevelEnum.FREE]: {
			label: "Unlimited notification subscribers",
	...
	[FeatureNameEnum.PLATFORM_ACTIVITY_FEED_RETENTION]: {
		[ApiServiceLevelEnum.FREE]: {
			label: "24 hours activity feed retention",
			value: 24,
			timeSuffix: "h",
		},
		[ApiServiceLevelEnum.PRO]: {
			label: "7 days activity feed retention",
			value: 7,
			timeSuffix: "d",
		},
		[ApiServiceLevelEnum.BUSINESS]: {
			label: "90 days activity feed retention",
			value: 90,
			timeSuffix: "d",
		},
		[ApiServiceLevelEnum.ENTERPRISE]: {
	...
	[FeatureNameEnum.PLATFORM_MAX_DIGEST_WINDOW_TIME]: {
		[ApiServiceLevelEnum.FREE]: {
			label: "24 hours max digest window time",
			value: 24,
			timeSuffix: "h",
		},
		[ApiServiceLevelEnum.PRO]: {
			label: "7 days max digest window time",
			value: 7,
			timeSuffix: "d",
		},
		[ApiServiceLevelEnum.BUSINESS]: {
			label: "90 days max digest window time",
			value: 90,
			timeSuffix: "d",
		},
		[ApiServiceLevelEnum.ENTERPRISE]: {
			label: "Custom digest window time",
			value: UNLIMITED_VALUE,
			timeSuffix: "d",
		},
		[ApiServiceLevelEnum.UNLIMITED]: {
	...
	[FeatureNameEnum.PLATFORM_MAX_DELAY_DURATION]: {
		[ApiServiceLevelEnum.FREE]: {
			label: "24 hours max delay duration",
			value: 24,
			timeSuffix: "h",
		},
		[ApiServiceLevelEnum.PRO]: {
			label: "7 days max delay duration",
			value: 7,
			timeSuffix: "d",
		},
		[ApiServiceLevelEnum.BUSINESS]: {
			label: "90 days max delay duration",
			value: 90,
			timeSuffix: "d",
		},
		[ApiServiceLevelEnum.ENTERPRISE]: {
			label: "Custom delay duration",
			value: UNLIMITED_VALUE,
			timeSuffix: "d",
		},
		[ApiServiceLevelEnum.UNLIMITED]: {
	...
	[FeatureNameEnum.PLATFORM_MAX_THROTTLE_WINDOW_TIME]: {
		[ApiServiceLevelEnum.FREE]: {
			label: "1 hour max throttle window",
			value: 1,
			timeSuffix: "h",
		},
		[ApiServiceLevelEnum.PRO]: {
			label: "24 hours max throttle window",
			value: 24,
			timeSuffix: "h",
		},
		[ApiServiceLevelEnum.BUSINESS]: {
			label: "7 days max throttle window",
			value: 7,
			timeSuffix: "d",
		},
		[ApiServiceLevelEnum.ENTERPRISE]: {
			label: "Custom throttle window",
			value: UNLIMITED_VALUE,
			timeSuffix: "d",
		},
		[ApiServiceLevelEnum.UNLIMITED]: {
	...
	[FeatureNameEnum.PLATFORM_MAX_SNOOZE_DURATION]: {
		[ApiServiceLevelEnum.FREE]: {
			label: "Up to 24 hours max snooze duration",
			value: 24,
			timeSuffix: "h",
		},
		[ApiServiceLevelEnum.PRO]: {
			label: "Up to 90 days max snooze duration",
			value: 90,
			timeSuffix: "d",
		},
		[ApiServiceLevelEnum.BUSINESS]: {
	...
	[FeatureNameEnum.ACCOUNT_CUSTOM_SAML_SSO_OIDC_BOOLEAN]: {
		[ApiServiceLevelEnum.FREE]: {
			label: "SAML and Enterprise SSO providers",
			value: false,
		},
		[ApiServiceLevelEnum.PRO]: {
			label: "SAML and Enterprise SSO providers",
	...
	[FeatureNameEnum.COMPLIANCE_CUSTOM_SECURITY_REVIEWS]: {
		[ApiServiceLevelEnum.FREE]: {
			label: "Security reviews: SOC 2 and ISO 27001 upon request",
			value: true,
		},
		[ApiServiceLevelEnum.PRO]: {
			label: "Security reviews: SOC 2 and ISO 27001 upon request",
...
export function getFeatureForTierAsBoolean(
	...
	if (isDetailedPriceListItem(feature)) {
		...
		if (typeof feature.value === "number") {
			...
			throw new Error(
				`Cannot convert number ${feature.value} to boolean for ${featureName} at tier ${tier}`,
			);
		}
		if (typeof feature.value === "string") {
			...
			throw new Error(
				`Cannot convert string "${feature.value}" to boolean for ${featureName} at tier ${tier}`,
			);
		}
	}
	...
	if (typeof feature === "number") {
		...
		throw new Error(
			`Cannot convert number ${feature} to boolean for ${featureName} at tier ${tier}`,
		);
	}
	...
	if (typeof feature === "string") {
		...
		if (lowercased === "false") return false;
		throw new Error(
			`Cannot convert string "${feature}" to boolean for ${featureName} at tier ${tier}`,
		);
	}

	throw new Error(
		`Cannot convert feature ${featureName} at tier ${tier} to boolean`,
	);
}
...
export function getFeatureForTierAsDateRangeValue(
	...
	throw new Error(
		`Cannot convert feature ${featureName} at tier ${tier} to date range`,
	);
}

function handleDetailedPriceListItem(
	feature: DetailedPriceListItem,
	conversionToMs: boolean | undefined,
) {
	if (typeof feature.value === "number") {
	...
	throw new Error(
		`Cannot convert detailed price list item to number[${feature.value}]`,
	);
}
...
export function getFeatureForTierAsNumber(
	...
	if (conversionToMs) {
		throw new Error(
			`Cannot convert [${featureName}] at tier [${tier}] to milliseconds without unit info`,
		);
	}
	...
	throw new Error(
		`Cannot convert feature ${featureName} at tier ${tier} to number`,
	);
}
function stringAsNumber(
	...
	if (Number.isNaN(parsed)) {
		throw new Error(
			`Cannot convert string [${featureName}] at tier ${tier} to number`,
		);
	}
