...
const routes: MockRoute[] = [
  ...
  { pattern: /^\/v1\/environments\/api-keys$/, response: { data: [{ _id: "key_001", key: "mock-api-key-dev-xxxxx", _environmentId: "env_dev_001" }] } },
  { pattern: /^\/v2\/environments\/[^/]+\/tags$/, response: { data: [{ name: "onboarding" }, { name: "transactional" }, { name: "security" }, { name: "billing" }, { name: "social" }] } },
  { pattern: /^\/v1\/billing\/subscription$/, response: { data: { apiServiceLevel: "free", isActive: true, hasPaymentMethod: false, status: "active", trial: { isActive: false, start: "2026-01-01", end: "2026-01-14", daysTotal: 14 }, currentPeriodStart: "2026-03-01", currentPeriodEnd: "2026-04-01" } } },
  { pattern: /^\/v1\/telemetry/, response: { data: {} } },
  { pattern: /^\/v2\/environments\/[^/]+\/diff$/, response: { data: { changes: [] } } },
];
