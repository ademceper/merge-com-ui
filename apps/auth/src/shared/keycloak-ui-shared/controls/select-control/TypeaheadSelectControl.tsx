 ...
 *
 * $ npx keycloakify own --path "shared/keycloak-ui-shared/controls/select-control/TypeaheadSelectControl.tsx"
 *
...
>({
    ...
    const [selectedOptionsState, setSelectedOptions] = useState<SelectControlOption[]>(
        []
    );
                    ...
                    <Select
                        ...
                        onSelect={(event, v) => {
                            ...
                            if (isTypeaheadMulti && Array.isArray(field.value)) {
                                ...
                                field.onChange(
                                    Array.isArray(field.value) ? [option] : option
                                );
                                setOpen(false);
                            }
                        }}
