            ...
            {protocol === "openid-connect" && (
                <div className="flex flex-col gap-5">
                    <div className="flex w-full items-center justify-between gap-2">
                        <Label htmlFor="kc-authentication">
                    ...
                    <div className="flex w-full items-center justify-between gap-2">
                        <Label htmlFor="kc-authorization">
                                ...
                                render={({ field }) => (
                                    <div className="flex w-full items-center justify-between gap-2">
                                        <div className="flex items-center gap-2">
                                            ...
                                            />
                                            <Label htmlFor="kc-flow-standard">
                                                {t("standardFlow")}
                                            </Label>
                                        </div>
                                        <HelpItem
                                    ...
                                    <div className="flex w-full items-center justify-between gap-2">
                                        <div className="flex items-center gap-2">
                                            <Checkbox
                                                ...
                                                onCheckedChange={field.onChange}
                                            />
                                            <Label htmlFor="kc-flow-implicit">
                                                {t("implicitFlow")}
                                            </Label>
                                        </div>
                                        <HelpItem
                                ...
                                render={({ field }) => (
                                    <div className="flex w-full items-center justify-between gap-2">
                                        <div className="flex items-center gap-2">
                                            ...
                                            />
                                            <Label htmlFor="kc-flow-service-account">
                                                {t("serviceAccount")}
                                            </Label>
                                        </div>
                                        <HelpItem
                                        ...
                                        <div className="flex w-full items-center justify-between gap-2">
                                            <div className="flex items-center gap-2">
                                                <Checkbox
                                                    ...
                                                    disabled={clientAuthentication}
                                                />
                                                <Label htmlFor="kc-standard-token-exchange-enabled">
                                                    {t("standardTokenExchangeEnabled")}
                                                </Label>
                                            </div>
                                            <HelpItem
                                                helpText={t(
                                        ...
                                        <div className="flex w-full items-center justify-between gap-2">
                                            <div className="flex items-center gap-2">
                                                <Checkbox
                                                    ...
                                                    disabled={clientAuthentication}
                                                />
                                                <Label htmlFor="kc-jwt-authorization-grant-enabled">
                                                    {t("jwtAuthorizationGrantEnabled")}
                                                </Label>
                                            </div>
                                            <HelpItem
                                                helpText={t(
                                        ...
                                        <div className="flex w-full items-center justify-between gap-2">
                                            <div className="flex items-center gap-2">
                                                <Checkbox
                                                    ...
                                                    onCheckedChange={field.onChange}
                                                />
                                                <Label htmlFor="kc-oauth-device-authorization-grant">
                                                    {t("oauthDeviceAuthorizationGrant")}
                                                </Label>
                                            </div>
                                            <HelpItem
                                                helpText={t(
                                    ...
                                    <div className="flex w-full items-center justify-between gap-2">
                                        <div className="flex items-center gap-2">
                                            <Checkbox
                                                ...
                                                disabled={clientAuthentication}
                                            />
                                            <Label htmlFor="kc-oidc-ciba-grant">
                                                {t("oidcCibaGrant")}
                                            </Label>
                                        </div>
                                        <HelpItem
