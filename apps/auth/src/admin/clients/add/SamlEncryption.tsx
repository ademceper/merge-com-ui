 ...
 *
 * $ npx keycloakify own --path "admin/clients/add/SamlEncryption.tsx"
 *
...
export const SamlEncryption = () => {
    ...
    const ALGORITHM_RSA_OAEP_MGF1P = "http://www.w3.org/2001/04/xmlenc#rsa-oaep-mgf1p";
    const keyEncryptionAlgorithm = watch(
        convertAttributeNameToForm<FormFields>("attributes.saml.encryption.keyAlgorithm"),
        ""
    );
