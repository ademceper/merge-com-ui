    ...
    return (
      <div className={cn("relative flex w-full items-stretch", className)}>
        <input
          ...
          type="number"
          data-slot="input"
          className={cn(numberInputBase, hideNativeSpinner, "pr-10")}
          value={value === "" ? "" : value}
          ...
          {...props}
        />
        <div className="absolute right-0 top-0 flex h-full flex-col overflow-hidden rounded-r-lg border-l border-border/50 [&_button]:h-1/2 [&_button]:min-h-0">
          <Button
            type="button"
            variant="ghost"
            size="xs"
