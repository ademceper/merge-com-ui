export const ROUTES = {
    ...
    CLIENTS_DEDICATED_SCOPE_MAPPER: "/:realm/clients/:id/clientScopes/dedicated/mappers/:mapperId/:viewMode",
    ...
    CLIENTS_AUTH_RESOURCE_DETAIL: "/:realm/clients/:id/authorization/resource/:resourceId",
    ...
    CLIENTS_AUTH_POLICY_DETAIL: "/:realm/clients/:id/authorization/policy/:policyId/:policyType",
    CLIENTS_AUTH_PERMISSION_NEW: "/:realm/clients/:id/authorization/permission/new/:permissionType",
    CLIENTS_AUTH_PERMISSION_NEW_SELECTED: "/:realm/clients/:id/authorization/permission/new/:permissionType/:selectedId",
    CLIENTS_AUTH_PERMISSION_DETAIL: "/:realm/clients/:id/authorization/permission/:permissionType/:permissionId",
    CLIENTS_PERMISSION_CONFIG_DETAIL: "/:realm/clients/:id/permissions/permission/:permissionId/:permissionType",
    CLIENTS_REGISTRATION_PROVIDER: "/:realm/clients/client-registration/:subTab/:providerId",
    CLIENTS_REGISTRATION_PROVIDER_DETAIL: "/:realm/clients/client-registration/:subTab/:providerId/:id",
    ...
    IDENTITY_PROVIDERS_MAPPER_ADD: "/:realm/identity-providers/:providerId/:alias/:tab/create",
    IDENTITY_PROVIDERS_MAPPER_EDIT: "/:realm/identity-providers/:providerId/:alias/mappers/:id",
    ...
    PERMISSIONS_POLICY_NEW: "/:realm/permissions/:permissionClientId/policies/new/:policyType",
    PERMISSIONS_POLICY_DETAIL: "/:realm/permissions/:permissionClientId/policies/:policyId/:policyType",
    PERMISSIONS_NEW: "/:realm/permissions/:permissionClientId/permission/new/:resourceType",
    PERMISSIONS_DETAIL: "/:realm/permissions/:permissionClientId/permission/:permissionId/:resourceType",
    ...
    REALM_SETTINGS_KEY_PROVIDER: "/:realm/realm-settings/keys/providers/:id/:providerType/settings",
    ...
    REALM_SETTINGS_CLIENT_POLICY_ADD: "/:realm/realm-settings/client-policies/policies/add-client-policy",
    REALM_SETTINGS_CLIENT_POLICY_EDIT: "/:realm/realm-settings/client-policies/:policyName/edit-policy",
    REALM_SETTINGS_CLIENT_POLICY_CONDITION_ADD: "/:realm/realm-settings/client-policies/:policyName/edit-policy/create-condition",
    REALM_SETTINGS_CLIENT_POLICY_CONDITION_EDIT: "/:realm/realm-settings/client-policies/:policyName/edit-policy/:conditionName/edit-condition",
    REALM_SETTINGS_CLIENT_PROFILE_ADD: "/:realm/realm-settings/client-policies/:tab/add-profile",
    REALM_SETTINGS_CLIENT_PROFILE_EDIT: "/:realm/realm-settings/client-policies/:profileName/edit-profile",
    REALM_SETTINGS_EXECUTOR: "/:realm/realm-settings/client-policies/:profileName/edit-profile/:executorName",
    REALM_SETTINGS_EXECUTOR_ADD: "/:realm/realm-settings/client-policies/:profileName/add-executor",
    REALM_SETTINGS_USER_PROFILE_TAB: "/:realm/realm-settings/user-profile/:tab",
    REALM_SETTINGS_ATTRIBUTE_ADD: "/:realm/realm-settings/user-profile/attributes/add-attribute",
    REALM_SETTINGS_ATTRIBUTE_EDIT: "/:realm/realm-settings/user-profile/attributes/:attributeName/edit-attribute",
    REALM_SETTINGS_ATTRIBUTES_GROUP_NEW: "/:realm/realm-settings/user-profile/attributesGroup/new",
    REALM_SETTINGS_ATTRIBUTES_GROUP_EDIT: "/:realm/realm-settings/user-profile/attributesGroup/edit/:name",
