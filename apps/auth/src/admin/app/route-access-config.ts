...
/**
 * Route access configuration for sidebar navigation.
 * NOT used for routing (handled by TanStack Router file-based routing).
 */
export const routeAccessConfig: AppRouteObject[] = [
