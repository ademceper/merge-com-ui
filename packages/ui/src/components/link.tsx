    ...
    return (
        <a
            ...
            className={cn(
                ...
                "before:origin-left before:scale-x-100 before:transition-transform before:duration-300 before:ease-in-out",
        ...
        >
            {children}
            <svg
                className="ml-[0.3em] mt-0 size-[0.55em] translate-y-0 opacity-100 transition-all duration-300 [motion-reduce:transition-none] sm:translate-y-1 sm:opacity-0 sm:group-hover:translate-y-0 sm:group-hover:opacity-100 motion-reduce:transition-none"
                fill="none"
                viewBox="0 0 10 10"
