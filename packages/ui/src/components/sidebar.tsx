...
function SidebarPageHeader({ className, children, ...props }: React.ComponentProps<"header">) {
  ...
  return (
    <header
      ...
      className={cn(
        "flex h-12 shrink-0 items-center px-4 bg-sidebar",
        className
      )}
      {...props}
    >
...
function SidebarPage({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      data-slot="sidebar-page"
      className="flex flex-1 flex-col bg-background rounded-t-xl shadow-sm overflow-clip min-h-0 pt-1.5"
    >
      <div
        className={cn(
...
const sidebarMenuButtonVariants = cva(
  "peer/menu-button group/menu-button flex w-full items-center gap-2 overflow-hidden rounded-md px-2 py-1.5 text-left text-sm font-medium text-sidebar-foreground ring-sidebar-ring outline-hidden transition-[width,height,padding] group-has-data-[sidebar=menu-action]/menu-item:pr-8 group-data-[collapsible=icon]:size-8! group-data-[collapsible=icon]:p-2! hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 active:bg-sidebar-accent active:text-sidebar-accent-foreground disabled:pointer-events-none disabled:opacity-50 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-open:hover:bg-sidebar-accent data-open:hover:text-sidebar-accent-foreground data-active:bg-sidebar-accent data-active:font-medium data-active:text-sidebar-accent-foreground [&_svg]:size-4 [&_svg]:shrink-0 [&>span:last-child]:truncate",
  {
    variants: {
      variant: {
